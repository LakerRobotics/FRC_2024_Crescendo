...
import edu.wpi.first.wpilibj2.command.SequentialCommandGroup;
  ...
  public class AutoShootSpeakerTwoNoteAmpSide extends SequentialCommandGroup{


  public AutoShootSpeakerTwoNoteAmpSide (ArmSubsystem mArmSubsystem, LauncherSubsystem mLauncherSubsystem, IntakeSubsystem mIntakeSubsystem,DriveSubsystem m_driveTrain) {
    ...
    addCommands( new DriveTrainMove(m_driveTrain, 0.2, 0, 0.05).withTimeout(2.4));
