...
import edu.wpi.first.wpilibj2.command.SequentialCommandGroup;
  ...
  public class AutoShootSpeakerCrossLine extends SequentialCommandGroup{


  public AutoShootSpeakerCrossLine (ArmSubsystem mArmSubsystem, LauncherSubsystem mLauncherSubsystem, IntakeSubsystem mIntakeSubsystem,DriveSubsystem m_driveTrain) {
